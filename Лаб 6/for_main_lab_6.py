...
class Rose(Device):  # квітка 1
    def __init__(self, price, fresh, len_f):
        Device.__init__(self, price, fresh, len_f)
        self.name = "Троянда"


class Chamomile(Device):   # квітка 2
    def __init__(self, price, fresh, len_f):
        Device.__init__(self, price, fresh, len_f)
        self.name = "Ромашка"


class Tulip(Device):  # квітка 3
    def __init__(self, price, fresh, len_f):
        Device.__init__(self, price, fresh, len_f)
        self.name = "Тюльпан"


class Orchid(Device):   # квітка 4
    def __init__(self, price, fresh, len_f):
        Device.__init__(self, price, fresh, len_f)
        self.name = "Орхідея"
